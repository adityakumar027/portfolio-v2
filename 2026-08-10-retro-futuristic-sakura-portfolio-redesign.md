...
### 5.3 Typography
- **UI/Data/Terminal:** Martian Mono (variable, `--font-mono`)
- **Body/Headings:** Bricolage Grotesque (variable, `--font-sans`)
- **Display/Hero:** Unbounded (variable, `--font-display`) — hero title (approach zone), big numerals, zone section markers only
